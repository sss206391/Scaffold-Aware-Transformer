...
PROJECT_PATHS = {
    "SMILES_TOKENS_PATH": "new_logics_pack/logics_tokens.txt",
    "EXPERIMENT_SETTINGS_JSON": "new_logics_pack/experiment_settings.json",
    "PRETRAIN_SETTING_JSON": "new_logics_pack/pretrain_setting.json",
    ...
    "new_guacamol_data":  "dataset/SMILES/guacamol_raw.smi",
    "new_moses_data": "dataset/SMILES/moses_raw.smi",
